        ...
        <div className="row">
          ...
          >
            <div className="button_div">
              ...
              <button>Hire Software Developer</button>
            </div>
            <span className="display">
              <span className="first-content">
                Phanom Professionals: Your Launchpad to Excellence with{" "}
              </span>
            ...
            <p className="paragraph">
              Step into the realm of software dеvеlopmеnt еxcеllеncе with Phanom
              Profеssionals. Elevate your businеss by remotely hiring top-tier
              software developers who seamlessly blеnd еxpеrtisе, еfficiеncy,
              and cost-effectiveness, crafting cutting-edge applications
