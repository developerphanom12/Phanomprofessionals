      ...
      <div className="container ">
        ...
        <div className="main_div">
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-12 segment ">
              <div className="que">
                <h4>Where can I find a Laravel specialist?</h4>
                <button
                  type="button"
                  className="btn btn-primary"
                  data-bs-toggle="collapse"
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-12 segment">
              <div className="que">
                <h4>
                  What is a great PHP framework for developing an app or
                  website?
                </h4>
                <button
                  type="button"
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-12 segment">
              <div className="que">
                <h4>Will the Laravel features I use work in my timeline?</h4>
                <button
                  type="button"
                  className="btn btn-primary"
                  data-bs-toggle="collapse"
              ...
              <div id="demo8" className="collapse show6">
                Yes, if you hire a Larvel developer from Phanom Profеssionals,
                you will get your timeline flexibility.
              </div>
            </div>
          </div>
